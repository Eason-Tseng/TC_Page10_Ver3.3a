...
#include "SMEM.h"
//---------------------------------------------------------------------------
ScreenActSpecialDayView screenActSpecialDayView;
//---------------------------------------------------------------------------
ScreenActSpecialDayView::ScreenActSpecialDayView(void)
{
    loadBitmapFromFile();
    initDispWord();
    cPosition=0;
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::loadBitmapFromFile(void)
{
try {
    FILE *bitmap;
    bitmap=fopen("//cct//bitmap//backGround//TC5F//ActspecialDayView.bit","rb");
    if (bitmap) {
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::DisplayActSpecialDayView(int iSegIn)
{
try {
    smem.SetcFace(cACTSPECIALDAYVIEW);
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::initDispWord(void)
{
try {
    for (int i=0;i<8;i++) {
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::DisplayDate(void)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::LoadActSpecialDaySegtype(void)
{
try {
    for (int i=8;i<=20;i++) {
         ...
         printf("stc._act_panel_holidayseg._start_year %d\n", stc._act_panel_holidayseg._start_year);
         printf("stc._act_panel_holidayseg._start_month %d\n", stc._act_panel_holidayseg._start_month);
         printf("stc._act_panel_holidayseg._start_day %d\n", stc._act_panel_holidayseg._start_day);
         printf("stc._act_panel_holidayseg._end_year %d\n", stc._act_panel_holidayseg._end_year);
         printf("stc._act_panel_holidayseg._end_month %d\n", stc._act_panel_holidayseg._end_month);
         printf("stc._act_panel_holidayseg._end_day %d\n", stc._act_panel_holidayseg._end_day);

    }
  } catch (...) {}
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::DisplayActSpecialDaySegtype(int iSeg)
{
try {
    BYTE space[16]={0};
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyWork(BYTE key)
{
try {
    switch (key) {
        case 0x80:
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey0Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey1Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey2Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey3Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey4Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey5Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey6Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey7Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey8Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKey9Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyAWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyBWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyCWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyDWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyEWork(void)
{
  if(iSeg > 8)
    DisplayActSpecialDayView(iSeg-1);
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyFWork(void)
{
  if(iSeg < 20)
    DisplayActSpecialDayView(iSeg+1);
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyF1Work(void)
{
    screenMain.DisplayMain();
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyF2Work(void)
{
  smem.vWriteMsgToDOM("F2");
     screenActSpecialDayEditF2.DisplayActSpecialDayView(iSeg);
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyF3Work(void)
{

}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyF4Work(void)
{
    screenActspecialDay.DisplayActspecialDay();
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyUPWork(void)
{
try {
  /*
  if(iSeg > 8)
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyDOWNWork(void)
{
try {
  /*
  if(iSeg < 20)
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyLEFTWork(void)
{
try {
  } catch(...) {}
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyRIGHTWork(void)
{
try {
  } catch(...) {}
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::doKeyEnterWork(void)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::vDiskplayActSpecialDayID(int iSpecialDayIDIn)
{
try{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayView::vDiskplaySegID(int iSegIn)
{
try{
