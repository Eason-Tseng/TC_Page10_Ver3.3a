...
class SMEM
{
    public:
        ...
        STORAGE disk;                                                           //�g�ɮץ�
        /*OTCombo0713*/
//        RS232 centerPort,lightPort,ssPort,keypadPort,testerPort,rtmsPort;       //�汱����,Light,SmartSensor,���O,�ⴣ���վ�,RTMS
...
//OTSS++
        UDP centerSocket,testerSocket,tempSocket;                               //�汱����,�ⴣ���վ�,�O�d
//        UDP VDBcastForListen5003Socket;                                         //VD�s��Socket
        UDP DynCalServerInCrossSocket, DynCalServerInCenterSocket;              //���ʺA�p��D��
...
/* OT ADD 950927 */
        ...
        int GetcFace(void);                                                     //�o��ثeLCD�W�O���ӵe��
        int GetLastFace(void);                                                  //�o��W��LCD�W�O���ӵe��
        int GetAddress(void);                                                   //�o��ثe���f�s��
        int GetOperMode(void);                                                  //�o��ثe�ާ@�Ҧ� 1:���ݾާ@ 0:�{���ާ@
        int GetSequence(void);                                                  //�o������W���y���s��
        bool GetKeypadReturn(void);                                             //�o��keypad�O�_���^�ǤF
        char * GetPassword(void);                                               //�o�챱��K�X
        int GetDbOperStat(void);                                                //�o���Ʈw�ާ@�]�w(0:���\�{���ާ@,1:�����\�{���ާ@,2:�u���\�{���d��)
        bool GetSSComm(void);                                                   //�o��PSmartSensor���q�T

        bool SetcFace(int);                                                     //�]�w�ثeLCD�O���ӵe��
        bool SetLastFace(int);                                                  //�]�w�W��LCD�O���ӵe��
        bool SetAddress(int);                                                   //�]�w�ثe���f�s��
        bool SetOperMode(int);                                                  //�]�w�ثe�ާ@�Ҧ� 1:���ݾާ@ 0:�{���ާ@
        bool SetKeypadReturn(bool);                                             //�]�wkeypad�O�_���^�ǤF
        bool SetPassword(char,char,char,char,char,char);                        //�]�w����K�X
        bool SetDbOperStat(int);                                                //�]�w��Ʈw�ާ@�]�w(0:���\�{���ާ@,1:�����\�{���ާ@,2:�u���\�{���d��)
        bool SetSSComm(bool);                                                   //�]�w�PSmartSensor���q�T

        bool SetWaitMsg(int,BYTE *,int);                                        //�O���n���ݦ^����msg
        bool ClearWaitMsg(int);                                                 //�������Ԧ^����msg

        time_t GetLastKeypadTime(void);                                         //�o��̫�@������L���ɶ�
        bool SetLastKeypadTime(void);                                           //�]�w�̫�@������L���ɶ�

        time_t GetStartTime(void);                                              //�o�즹�{���Ұʮɶ�
        ...
        unsigned char vGetHardwareStatus(int);                                 //�u��vGet�S��vSet�A�G�N���A��vGet�ۦ�P�_
...
/*new add */
        SmartSensorINFO vGetSSInfo(void);                                       //Ū�XS0data

        bool vSetLastResetTime(long);                                           //�NDOM�������̫�ɶ��g�Jsmem
        YMDHMS vGetLastResetTime(void);                                         //�qsmemŪ�X�W���������ɶ�
        ...
        bool bConnectWithCenter;                                                //�����P����Ϊ� old
        bool bConnectWithCenterStatus;                                          //�s�u���ߪ�status
...
//OT Debug 0706        bool vSyncSSTimeInterVal(void);
        ...
        bool vSaveLastAliveStatus();                                             //��SS�_�u�ɡA��interval�Ӭ����ɶ�toDOM
...
//---------------------------------------------------------------------
    private:
        ...
        void InitialSMem(void);                                                 //��l�ưO����γq�T���m

        int address;                                                            //���]�Ƹ��f�s��
        int cFace;                                                              //�ثeLCD�e���W������
        int lastFace;                                                           //�W�@�����d���e��
        int operMode;                                                           //�����ާ@�Ҧ� 1:���ݾާ@ 0:�{���ާ@
        int sequence;                                                           //�����W�n�e�X���y���s��
        char password[6];                                                       //����K�X
        int dbOperStat;                                                         //��Ʈw�ާ@�]�w(0:���\�{���ާ@,1:�����\�{���ާ@,2:�u���\�{���d��)
        ...
        bool keypadReturn;                                                      //�ڭ̥����ɥ�keypad���^�ǭȨӳ]�w���f�s��(address)�ξާ@�Ҧ�(operMode)
        time_t lastKeypadTime;                                                  //�̫�@������L���ɶ�


        MESSAGEWAITREPONSE msgWaitResponse[MSGWAITREPONSECOUNT];                //���Ǿ���
        ...
        bool bSmem92TC_SubPhaseOfPhasePlanIncorrent;                            //��Phase�PPlan�w�q��subphase���P�ɡA��flag��true

//OT Debug 0523
        bool bTC_ActuateTypeFunctionEnable;
        bool bSmemTC_CCT_In_LongTanu_ActuateType_Switch;                        //�s��S�OĲ��, 1 cycle change execplan
...
//OT Debug Signal 951116
        ...
        bool b92VDUpdateDB_Status;                                              //�ۤw�[���A��Interval�P�_�����
