...
//---------------------------------------------------------------------------
ScreenActWeekDayEditF2 screenActWeekDayEditF2;
//---------------------------------------------------------------------------
ScreenActWeekDayEditF2::ScreenActWeekDayEditF2(void)
{
    loadBitmapFromFile();
    initDispWord();
    for (int i=0;i<14;i++) {
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::loadBitmapFromFile(void)
{
try {
    FILE *bitmap;
    bitmap=fopen("//cct//bitmap//backGround//TC5F//ActweekDayEditF2.bit","rb");
    if (bitmap) {
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::DisplayActuateWeekDay(void)
{
try {
    smem.SetcFace(cACTWEEKDAYEDITF2);
    lcd240x128.DISPLAY_GRAPHIC(0,weekDayBitmap,128,30);
    DisplayDate();

    LoadActWeekDaySegtype(true);
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::vDisplayActWeekDayFromPreview(int iSegtypePreviewSelectd)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::initDispWord(void)
{
try {
    for (int i=0;i<8;i++) {
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::DisplayDate(void)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::LoadActWeekDaySegtype(bool bLoadFromCSTC)
{
try {
    if(bLoadFromCSTC) {
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::DisplayActWeekDaySegtype(void)
{
try {
...
//---------------------------------------------------------------------------
bool ScreenActWeekDayEditF2::SaveActWeekDaySegtype(bool bSaveToCSTC)
{
try {
    bool bCheckOK;
    int tmp_segtype = 0;
    ...
    if(bCheckOK) {
      ...
      if(bSaveToCSTC) {
        stc.Lock_to_Save_Actuate_WeekDaySegment_from_Panel();
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyWork(BYTE key)
{
try {
    switch (key) {
        case 0x80:
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey0Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey1Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey2Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey3Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey4Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey5Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey6Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey7Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey8Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKey9Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyAWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyBWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyCWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyDWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyEWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyFWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyF1Work(void)
{
    screenMain.DisplayMain();
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyF2Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyF3Work(void)
{
    SaveActWeekDaySegtype(true);
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyF4Work(void)
{
    screenActuateWeekDay.DisplayActuateWeekDay();
}
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyUPWork(void)
{
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyDOWNWork(void)
{
    clearCursor8x16(segtypeWord[cSegPosition].X,segtypeWord[cSegPosition].Y+16);
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyLEFTWork(void)
{
try {
    clearCursor8x16(segtypeWord[cSegPosition].X,segtypeWord[cSegPosition].Y+16);
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyRIGHTWork(void)
{
try {
    clearCursor8x16(segtypeWord[cSegPosition].X,segtypeWord[cSegPosition].Y+16);
    cSegPosition++;
...
//---------------------------------------------------------------------------
void ScreenActWeekDayEditF2::doKeyEnterWork(void)
{
    // bool bRet;
    // bRet = SaveActWeekDaySegtype(false);
