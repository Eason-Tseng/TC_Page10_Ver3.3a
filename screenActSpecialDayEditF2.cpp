...
#include "SMEM.h"
//---------------------------------------------------------------------------
ScreenActSpecialDayEditF2 screenActSpecialDayEditF2;
//---------------------------------------------------------------------------
ScreenActSpecialDayEditF2::ScreenActSpecialDayEditF2(void)
{
    loadBitmapFromFile();
    initDispWord();
    cPosition=0;
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::loadBitmapFromFile(void)
{
try {
    FILE *bitmap;
    bitmap=fopen("//cct//bitmap//backGround//TC5F//ActspecialDayEditF2.bit","rb");
    if (bitmap) {
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::DisplayActSpecialDayView(int iSegIn)
{
try {
    smem.SetcFace(cACTSPECIALDAYEDITF2);
    ...
    DisplayDate();
    LoadActSpecialDaySegtype();
    DisplayActSpecialDaySegtype(iSegIn);
    vDiskplayActSpecialDayID(iSpecialDayID);
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::initDispWord(void)
{
try {
    for (int i=0;i<8;i++) {
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::DisplayDate(void)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::LoadActSpecialDaySegtype(void)
{
try {
    for (int i=8;i<=20;i++) {
         stc.Lock_to_Load_Actuate_HoliDaySegment_for_Panel(i);
         specialDaySegtype[i-8]._segment_type=stc._act_panel_holidayseg._segment_type;
         specialDaySegtype[i-8]._start_year=stc._act_panel_holidayseg._start_year;
         specialDaySegtype[i-8]._start_month=stc._act_panel_holidayseg._start_month;
         specialDaySegtype[i-8]._start_day=stc._act_panel_holidayseg._start_day;
         specialDaySegtype[i-8]._end_year=stc._act_panel_holidayseg._end_year;
         specialDaySegtype[i-8]._end_month=stc._act_panel_holidayseg._end_month;
         specialDaySegtype[i-8]._end_day=stc._act_panel_holidayseg._end_day;

         printf("stc._act_panel_holidayseg._seg %d\n", stc._act_panel_holidayseg._segment_type);
         printf("stc._end_year._reverse_time_type %d\n", stc._act_panel_holidayseg._end_year);

    }
  } catch (...) {}
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::DisplayActSpecialDaySegtype(int iSeg)
{
try {
    BYTE space[16]={0};
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyWork(BYTE key)
{
try {
    switch (key) {
        case 0x80:
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey0Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey1Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey2Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey3Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey4Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey5Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey6Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey7Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey8Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKey9Work(void)
{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyAWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyBWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyCWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyDWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyEWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyFWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyF1Work(void)
{
    screenMain.DisplayMain();
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyF2Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyF3Work(void)
{
  vTmpArrayToData();
  if(vCheck()) {
    vSaveActSpecialDay();
    smem.vWriteMsgToDOM("F3");
    screenActSpecialDayView.DisplayActSpecialDayView(iSeg);
    
  }
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyF4Work(void)
{
    smem.vWriteMsgToDOM("F4");
    screenActSpecialDayView.DisplayActSpecialDayView(iSeg);
}
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyUPWork(void)
{
try {
  if(cPosition >= 8) {
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyDOWNWork(void)
{
try {
  if(cPosition < 8) {
    clearCursor8x16(specialDayWord[cPosition].X,specialDayWord[cPosition].Y+16);
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyLEFTWork(void)
{
try {
    clearCursor8x16(specialDayWord[cPosition].X,specialDayWord[cPosition].Y+16);
  if(cPosition > 0)
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyRIGHTWork(void)
{
try {
  clearCursor8x16(specialDayWord[cPosition].X,specialDayWord[cPosition].Y+16);
  if(cPosition < 15)
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::doKeyEnterWork(void)
{
try {
/*
    vTmpArrayToData();
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::vDiskplaySegID(int iSegIn)
{
try{
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::vTmpArrayToData(void)
{
try{
...
//---------------------------------------------------------------------------
bool ScreenActSpecialDayEditF2::vCheck(void)
{
try{
  bool bRet = true;
...
//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::vSaveActSpecialDay(void)
{
try{
  stc._act_panel_holidayseg._segment_type = iSeg;
  stc._act_panel_holidayseg._start_year = specialDaySegtype[iSeg-8]._start_year;
  stc._act_panel_holidayseg._end_year = specialDaySegtype[iSeg-8]._end_year;
  stc._act_panel_holidayseg._start_month = specialDaySegtype[iSeg-8]._start_month;
  stc._act_panel_holidayseg._end_month = specialDaySegtype[iSeg-8]._end_month;
  stc._act_panel_holidayseg._start_day = specialDaySegtype[iSeg-8]._start_day;
  stc._act_panel_holidayseg._end_day = specialDaySegtype[iSeg-8]._end_day;

  stc.Lock_to_Save_Actuate_HoliDaySegment_from_Panel();

}catch(...){}
}

//---------------------------------------------------------------------------
void ScreenActSpecialDayEditF2::vDiskplayActSpecialDayID(int iSpecialDayIDIn)
{
try{
