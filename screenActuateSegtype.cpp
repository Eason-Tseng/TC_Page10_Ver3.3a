...
#include <stdio.h>
//---------------------------------------------------------------------------
ScreenActuateSegtype screenActuateSegtype;
//---------------------------------------------------------------------------
ScreenActuateSegtype::ScreenActuateSegtype(void)
{
    loadBitmapFromFile();
    initDispWord();
    cPosition=0;
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::loadBitmapFromFile(void)
{
try {
    FILE *bitmap;
    bitmap=fopen("//cct//bitmap//backGround//TC5F//Actuatesegtype.bit","rb");
    if (bitmap) {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::DisplayActuateSegtype(int segtype, int iPageIn)
{
try {
    //OTADD
    smem.SetcFace(cACTUATESEGTYPE);
    lcd240x128.DISPLAY_GRAPHIC(0,segtypeBitmap,128,30);                         //�e����
    DisplayTime();                                              //�e�ɶ�

    LoadActuateSegtype(segtype);                                                       //�o��{��ɶ���
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::LoadActuateSegtype(int segtype)
{
try {
    if (stc.Lock_to_Load_Actuate_Segment_for_Panel(segtype)) {
...
//---------------------------------------------------------------------------
int ScreenActuateSegtype::GetNowPlanOfSegtypeCount(void)
{
try {
    int count=0;
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::DisplayActuateSegtypeTable(int page)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::SaveActuateSegtype(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::initDispWord(void)
{
try {
    for (int i=0;i<4;i++) {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::DisplayTime(void)
{
try {
    unsigned short cHour=0,cMin=0;
    time_t currentTime=time(NULL);
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::DisplayItem(int page)
{
try {
    BYTE space[16]={0};
    for (int i=0;i<12;i+=2) {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::DisplayUpAndDownPage(int page)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::DisplayActuateSegmnetNo(void)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::DisplayActuateSegmnetCount(void)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyWork(BYTE key)
{
try {
    switch (key) {
        case 0x80:
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey0Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey1Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey2Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey3Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey4Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey5Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey6Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey7Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey8Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKey9Work(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyAWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyBWork(void)
{
  smem.vSetScreenCopySegID(segment._segment_type);
  printf("[printfMsg] copy seg:%d\n", segment._segment_type);
  DisplayActuateSegtype(segment._segment_type, iLastPage);
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyCWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyDWork(void)
{
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyEWork(void)
{
  if (cFace>1) {
      DisplayTime();
...
//      cPosition+=35;
    ...
    if(segment._segment_type > 1) {
      ...
      cFace = 1;
      cPosition = 0;
      DisplayActuateSegtype(segment._segment_type - 1, INVAILDVALUE);
    }
  }
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyFWork(void)
{
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyF1Work(void)
{
    screenMain.DisplayMain();
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyF2Work(void)
{
    screenActuateSegtypeEditF2.DisplayActuateSegtype(segment._segment_type);
}
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyF3Work(void)
{
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyUPWork(void)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyDOWNWork(void)
{
try {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyLEFTWork(void)
{
try {
    if (cSelect==0) {
    } else if (cSelect==1) {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyRIGHTWork(void)
{
try {
    if (cSelect==0) {
    } else if (cSelect==1) {
...
//---------------------------------------------------------------------------
void ScreenActuateSegtype::doKeyEnterWork(void)
{
    int x=-1;
    if (cSelect==2) {
        if (cPosition>=0 && cPosition<=6) x=segment._ptr_seg_exec_time[0+(cFace-1)*6]._actmod;
        else if (cPosition>=7 && cPosition<=13 && cFace<6) x=segment._ptr_seg_exec_time[3+(cFace-1)*6]._actmod;
        else if (cPosition>=14 && cPosition<=20 && cFace<6) x=segment._ptr_seg_exec_time[1+(cFace-1)*6]._actmod;
        else if (cPosition>=21 && cPosition<=27 && cFace<6) x=segment._ptr_seg_exec_time[4+(cFace-1)*6]._actmod;
        else if (cPosition>=28 && cPosition<=34 && cFace<6) x=segment._ptr_seg_exec_time[2+(cFace-1)*6]._actmod;
        else if (cPosition>=35 && cPosition<=41 && cFace<6) x=segment._ptr_seg_exec_time[5+(cFace-1)*6]._actmod;
    }
        if (x==4) screenActuateEdit.DisplayActuateEdit(cACTUATESEGTYPE);
}
//---------------------------------------------------------------------------
